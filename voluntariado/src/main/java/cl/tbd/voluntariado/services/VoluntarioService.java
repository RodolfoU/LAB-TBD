...
public class VoluntarioService {
    ...
    @CrossOrigin(origins = "*")
    @GetMapping("/voluntarios/puntos")
    @ResponseBody
    public List<Geometry> getVolPuntos(){
        return volRepository.getVolPuntos();
    }


    @CrossOrigin(origins = "*")
    @GetMapping("/voluntariosCercanos/emer={idEmer}&R={radio}")
    @ResponseBody
    public List<Geometry> getVolCercanoEmer(@PathVariable Integer idEmer, @PathVariable long radio){
        return volRepository.getVolCercanoEmer(idEmer,radio);
    }
